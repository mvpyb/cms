<template>
  <div class="about-container w920">
    <div class="min-height">
      ...
      <div v-loading="listLoading" class="about-content">
        <div >
          <div
        ...
        <div v-show="lists.length == 0 && !listLoading" class="empty">
...
export default {
  ...
  methods : {
    ...
    async viewDetails( data ) {
      console.log( data )
      this.$router.push( { path : '/dynamic/details', query : { id : data.id, fromPath : '/dynamic/association' }} )
    }
  }
}
</script>
